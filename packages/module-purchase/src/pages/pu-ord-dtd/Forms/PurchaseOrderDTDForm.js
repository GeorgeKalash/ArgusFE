...
export default function PurchaseOrderDTDForm({ labels, maxAccess, recordId, window }) {
  ...
  return (
    <FormShell resourceId={ResourceIds.PUDocumentTypeDefaults} form={formik} maxAccess={maxAccess} editMode={editMode}>
      <VertLayout>
        <Grow>
