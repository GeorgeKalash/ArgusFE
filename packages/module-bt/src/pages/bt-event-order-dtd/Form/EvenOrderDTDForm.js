...
export default function EvenOrderDTDForm({ labels, maxAccess, recordId, window }) {
  ...
  const { formik } = useForm({
    initialValues: {
      recordId,
      functionId: SystemFunction.EventOrder,
      dtId: null,
      plantId: null,
      spId: null
    },
          ...
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <ResourceComboBox
                ...
                parameters={`_startAt=0&_pageSize=1000&_dgId=${SystemFunction.EventOrder}`}
                name='dtId'
                required
