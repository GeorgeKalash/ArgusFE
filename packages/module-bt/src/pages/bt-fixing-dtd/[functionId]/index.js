...
import FixingDTDForm from './Forms/FixingDTDForm'
...
const FixingDTD = () => {
  ...
  const resourceId = functionId === SystemFunction.FixingSales ? 
    ResourceIds.FixingSalesDTD : 
    ResourceIds.FixingPurchaseDTD
  ...
  const {
    ...
    datasetId: ResourceIds.FixingSalesDTD,
