...
import UserIcon from '@argus/shared-layouts/src/layouts/components/UserIcon'
import Translations from '@argus/shared-layouts/src/layouts/components/Translations'
import CanViewNavGroup from '@argus/shared-layouts/src/layouts/components/acl/CanViewNavGroup'

// ** Utils
import { hexToRGBA } from '@argus/shared-core/src/@core/utils/hex-to-rgba'
import { hasActiveChild } from '@argus/shared-core/src/@core/layouts/utils'
