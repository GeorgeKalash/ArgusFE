...
import DamageReasonForm from './Form/DamageReason'
...
const DamageReason = () => {
  ...
  async function fetchGridData(options = {}) {
    ...
    const response = await getRequest({
      extension: ManufacturingRepository.DamageReason.page,
  ...
  const del = async obj => {
    await postRequest({
      extension: ManufacturingRepository.DamageReason.del,
