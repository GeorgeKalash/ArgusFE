...
export const AddressFormShell = ({
  ...
  const WorkAddressFormik = useForm({
    maxAccess,
  ...
  useEffect(() => {
    if (
      (WorkAddressFormik.values.name ||
        WorkAddressFormik.values.street1 ||
        WorkAddressFormik.values.phone ||
        WorkAddressFormik.values.countryId ||
        WorkAddressFormik.values.cityId) &&
      requiredOptional
    ) {
