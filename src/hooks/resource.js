...
export function useResourceQuery({ endpointId, filter, datasetId, queryFn, search, enabled = true, functionId }) {
  ...
  const query = useQuery({
    ...
    queryKey: [endpointId, searchValue, JSON.stringify(filters), apiOption, functionId],
