...
import PUOrderStatusForm from './forms/OrderStatusForm'
...
const PUOrderStatus = () => {
  ...
  const del = async obj => {
    try {
      await postRequest({
        extension: PurchaseRepository.PUOrderStatus.del,
