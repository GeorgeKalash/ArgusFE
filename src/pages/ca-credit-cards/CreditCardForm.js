...
export default function CreditCardForm({ recordId, labels, maxAccess }) {
  ...
  const { formik } = useForm({
    initialValues: {
      ...
      name: '',
      bankId: '',
      creditCardFees: [{ creditCardId: recordId, seqNo: 1, upToAmount: 0, commissionFees: 0, isPct: false }]
    },
    maxAccess: maxAccess,
  ...
  return (
    <FormShell resourceId={ResourceIds.CreditCard} form={formik} maxAccess={maxAccess} editMode={editMode}>
      <VertLayout>
        <Fixed>
