      ...
      <Grid container spacing={2} alignItems="center">
        <Grid item xs={6}>
          <CustomComboBox
            ...
            store={moduleStore}
            name='classId'
            value={Array.isArray(moduleStore) && moduleStore.filter(item => item.key === rowAccessValidation.values?.classId)[0] ||
              moduleStore[0]} // Select the first value if there's no match
            maxAccess={maxAccess}
        ...
        <Grid item xs={6} container spacing={1} alignItems="center" justifyContent="flex-start">
           <Button variant="contained" color="primary">Check All</Button>
           <Button variant="contained" color="secondary" sx={{ marginLeft: 2 }}>Uncheck All</Button>
        </Grid>
      </Grid>
    </Grid>
