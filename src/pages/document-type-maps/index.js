                ...
                <Grid container spacing={4}>
                    <Grid item xs={12}>
                        <CustomComboBox
                            ...
                            error={documentTypeMapsValidation.touched.fromFunctionId && Boolean(documentTypeMapsValidation.errors.fromFunctionId)}
                            helperText={documentTypeMapsValidation.touched.fromFunctionId && documentTypeMapsValidation.errors.fromFunctionId}
                        />
                    </Grid>
                    <Grid item xs={12}>
                        <CustomComboBox
                    ...
                    <Grid item xs={12}>
                        <CustomComboBox
                            ...
                            error={documentTypeMapsValidation.touched.toFunctionId && Boolean(documentTypeMapsValidation.errors.toFunctionId)}
                            helperText={documentTypeMapsValidation.touched.toFunctionId && documentTypeMapsValidation.errors.toFunctionId}
                        />
                    </Grid>
                    <Grid item xs={12}>
                        <CustomComboBox
