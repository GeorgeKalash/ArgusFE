...
const CcCashNotes = () => {
  ...
  async function fetchGridData(options = {}) {
    ...
    const response = await getRequest({
      extension: CashCountSettingsRepository.CcCashNotes.page,
  ...
  const {
    ...
    endpointId: CashCountSettingsRepository.CcCashNotes.page,
  ...
  const del = async obj => {
    await postRequest({
      extension: CashCountSettingsRepository.CcCashNotes.del,
