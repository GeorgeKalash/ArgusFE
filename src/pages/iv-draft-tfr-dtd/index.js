...
import DraftSerialsTransferDTDForm from './Forms/DraftSerialsTransferDTD'

const DraftSerialsTransferDTD = () => {
  ...
  async function fetchGridData(options = {}) {
    ...
    const response = await getRequest({
      ...
      parameters: `_startAt=${_startAt}&_pageSize=${_pageSize}&_filter=&_functionId=${SystemFunction.DraftTransfer}`
    })
  ...
  function openForm(record) {
    stack({
      Component: DraftSerialsTransferDTDForm,
      props: {
        labels,
      ...
      width: 600,
      height: 500,
      title: labels.DraftSerialsTransferDTD
    })
  }
...
export default DraftSerialsTransferDTD
