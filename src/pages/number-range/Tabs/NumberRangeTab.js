...
const NumberRangeTab = ({ labels, NumberRangeValidation, maxAccess, setRequired }) => {
  ...
  return (
    <Grid container spacing={4}>
      ...
      <Grid
        ...
        xs={12}
        sx={{
          opacity: !NumberRangeValidation.values.dateRange ? 0.4 : 1,
          pointerEvents: !NumberRangeValidation.values.dateRange ? 'none' : 'auto'
        }}
      >
        <CustomDatePicker
          name='startDate'
          ...
          onChange={NumberRangeValidation.setFieldValue}
          maxAccess={maxAccess}
