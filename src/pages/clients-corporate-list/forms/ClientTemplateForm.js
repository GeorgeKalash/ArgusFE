...
// Address
    ...
    postRequest({
      ...
      .then((res) => {
         ...
         formik.setFieldValue('clientId' , res.recordId)
         stack({
          Component: OTPPhoneVerification,
          props: {
            formValidation: formik,
            functionId: 3600,
            clientId: res.recordId,
...
return (
    <FormShell form={formik}  height={600} resourceId={ResourceIds.ClientCorporate}
    maxAccess={maxAccess} recordId={recordId} disabledSubmit={editMode} clientRelation={true}
    editMode={editMode}>
      <Grid container>
                    ...
                    <Grid container xs={12} spacing={3}>
                      ...
                      <Grid item xs={12}>
                        <CustomTextField
                          ...
                          error={
                            formik.touched.name1 &&
                            Boolean(formik.errors.name1)
                          }
                          helperText={
                            formik.touched.name1 &&
                            formik.errors.name1
                      ...
                      <Grid item xs={12}>
                        <ResourceComboBox
                          ...
                          error={
                            formik.touched.lgsId &&
                            Boolean(formik.errors.lgsId)
                          }
                          helperText={
                            formik.touched.lgsId &&
                            formik.errors.lgsId
