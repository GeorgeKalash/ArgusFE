      ...
      <VertLayout>
        <Fixed>
          <Grid container xs={12}>
            <Grid container xs={12} direction='row' spacing={2} sx={{ overflowX: 'auto', flexWrap: 'nowrap' }}>
              <Grid item xs={4}>
                <ResourceComboBox
            ...
            <Grid container xs={12} direction='row' spacing={2} sx={{ overflow: 'hidden', flexWrap: 'nowrap' }}>
              <Grid item xs={8}>
                <ResourceLookup
