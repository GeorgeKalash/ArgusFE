...
const ClientTemplateForm = ({
    ...
    await getRequest({
      ...
      .then((res) => {
        ...
        setInitialData({
          ...
          //clientIndividual
          birthDate:
            obj.clientIndividual.birthDate &&
            formatDateFromApi(obj.clientIndividual.birthDate),
          ...
          cellPhoneEncrypt:
            obj.clientMaster.cellPhone && obj.clientMaster.cellPhone,
          cellPhoneRepeatEncrypt:
            obj.clientMaster.cellPhone && obj.clientMaster.cellPhone,
  ...
  const postRtDefault = (obj) => {
    ...
    const data = {
      ...
      address: obj5,
      workAddress:
        obj6.name && obj6.countryId && obj6.cityId && obj6.phone && obj6.street1
          ? obj6
          : null,
    };
  ...
  const fillFilterProfession = (value) => {
    if (value) {
      const filteredList = professionStore?.filter(
                ...
                <FieldSet title={_labels.id}>
                  ...
                  <Grid item xs={12}>
                    <CustomDatePicker
                      ...
                      onChange={clientIndividualFormik.setFieldValue}
                      onClear={() =>
                        clientIndividualFormik.setFieldValue("expiryDate", "")
                      }
                  ...
                  <Grid item xs={12}>
                    <ResourceLookup
                      ...
                      readOnly={
                        (editMode ||
                          !clientIndividualFormik.values.idCountry) &&
                        true
                      }
                      maxAccess={maxAccess}
                      onChange={(event, newValue) => {
              ...
              <Grid container xs={12}>
                <FieldSet title={_labels.customerInformation}>
                    ...
                    <CustomTextField
                      ...
                      onBlur={(e) => {
                        setShowAsPasswordPhone(true),
                          clientIndividualFormik.handleBlur(e);
                      }}
                      onFocus={(e) => {
                        setShowAsPasswordPhone(false);
                      }}
                      onClear={() =>
                        clientIndividualFormik.setFieldValue("cellPhone", "")
                      }
                      error={
                  ...
                  <Grid container spacing={2} sx={{ paddingTop: "20px" }}>
                    <Grid item xs={3}>
                      <CustomTextField
                        ...
                        readOnly={editMode && true}
                        onClear={() =>
                          clientIndividualFormik.setFieldValue("firstName", "")
                        }
                        error={
                    ...
                    <Grid item xs={3}>
                      <CustomTextField
                        ...
                        readOnly={editMode && true}
                        onClear={() =>
                          clientIndividualFormik.setFieldValue("middleName", "")
                        }
                        error={
                    ...
                    <Grid item xs={3}>
                      <CustomTextField
                        ...
                        readOnly={editMode && true}
                        onClear={() =>
                          clientIndividualFormik.setFieldValue("lastName", "")
                        }
                        error={
                    ...
                    <Grid item xs={3}>
                      <CustomTextField
                        ...
                        readOnly={editMode && true}
                        onClear={() =>
                          clientIndividualFormik.setFieldValue("familyName", "")
                        }
                        error={
                  ...
                  <Grid item xs={12}>
                    <ResourceComboBox
                      endpointId={
                        RemittanceSettingsRepository.SourceOfIncome.qry
                      }
                      name="incomeSourceId"
                  ...
                  <Grid item xs={12}>
                    <CustomTextField
                      ...
                      maxLength="15"
                      onClear={() =>
                        clientIndividualFormik.setFieldValue("sponsorName", "")
                      }
                      error={
                ...
                <Grid container xs={12} spacing={2} sx={{ p: 5 }}>
                  ...
                  <Grid item xs={12}>
                    <ResourceComboBox
                      endpointId={
                        CurrencyTradingSettingsRepository.RiskLevel.qry
                      }
                      name="riskLevel"
                  ...
                  <Grid item xs={12}>
                    <CustomTextField
                      ...
                      maxLength="10"
                      onClear={() =>
                        clientIndividualFormik.setFieldValue("oldReference", "")
                      }
                      error={
                  ...
                  <Grid item xs={12}>
                    <CustomTextField
                      ...
                      maxLength="15"
                      onClear={() =>
                        clientIndividualFormik.setFieldValue("whatsAppNo", "")
                      }
                      error={
              ...
              <Grid item xs={12}>
                <FormControlLabel
                  control={
                    <Checkbox
                      disabled={
                        clientIndividualFormik.values.gender === "2" &&
                        !editMode
                          ? false
                          : true
                      }
