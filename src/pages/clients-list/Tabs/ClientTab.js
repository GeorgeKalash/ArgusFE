...
const ClientTab = ({
  ...
  const [showAsPasswordPhoneRepeat, setShowAsPasswordPhoneRepeat] =
    useState(false);
  ...
  const encryptDigits = (v) => {
    ...
    if (input?.length > 0) {
      ...
      const maskedValue = "*".repeat(showLength) + input?.substring(showLength);
            ...
            <Grid container spacing={2}>
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      name="isResident"
                      checked={
                        clientIndividualFormValidation.values?.isResident
                      }
                      onChange={clientIndividualFormValidation.handleChange}
              ...
              <Grid item xs={12}>
                <FieldSet title={_labels.id}>
                  ...
                  >
                    <CustomTextField
                      ...
                      required
                      onChange={(e) => {
                        clientIndividualFormValidation.handleChange(e);
                      }}
                      onCopy={handleCopy}
                      onPaste={handleCopy}
                      readOnly={editMode && true}
                  ...
                  >
                    <CustomTextField
                      ...
                      readOnly={editMode && true}
                      onBlur={(e) => {
                        setShowAsPasswordRepeat(true),
                          clientIndividualFormValidation.handleBlur(e);
                      }}
                      onFocus={(e) => {
                ...
                columnsInDropDown= {[
                  ...
                  {/* country comboBox used for country or nationality */}
                  <Grid item xs={12}>
                    <CountryComboBox
                      name="idCountry"
                      label={_labels.issusCountry}
                      formValidation={clientIndividualFormValidation}
                      readOnly={editMode && true}
                      resetField={["idCity", "cityName"]} // clear any value engaged with country value ex: city, state and cityDistrict
                  ...
                  <Grid item xs={12}>
                    <CustomLookup
                      ...
                      onLookup={lookupCity}
                      firstValue={
                        clientIndividualFormValidation.values.cityName
                      }
                ...
                <Grid item xs={12} sx={{ marginTop: "20px" }}>
                  <FieldSet title={_labels.address}>
                    <AddressTab
                      labels={_labels}
                      addressValidation={clientIndividualFormValidation}
                    ...
                    >
                      ...
                      <Grid item xs={12}>
                        <CustomTextField
                          ...
                          value={
                            clientIndividualFormValidation.values?.statusName
                          }
                          required
                          type="number"
                          onChange={clientIndividualFormValidation.handleChange}
                      ...
                      <Grid item xs={12}>
                        <CustomTextField
                          ...
                          value={
                            clientIndividualFormValidation.values?.oldReference
                          }
                          readOnly={editMode && true}
                          onChange={clientIndividualFormValidation.handleChange}
                          maxLength="10"
                      ...
                      <Grid item xs={12}>
                        <CustomTextField
                          ...
                          value={
                            clientIndividualFormValidation.values?.whatsAppNo
                          }
                          readOnly={editMode && true}
                          onChange={clientIndividualFormValidation.handleChange}
                          maxLength="15"
              ...
              <Grid container xs={12}>
                <FieldSet title={_labels.customerInformation}>
                  ...
                  >
                    <CustomTextField
                      ...
                      value={
                        clientIndividualFormValidation.values?.cellPhoneRepeat
                      }
                      phone={true}
                      required
                      readOnly={editMode && true}
                      ...
                      onBlur={(e) => {
                        setShowAsPasswordPhoneRepeat(true),
                          clientIndividualFormValidation.handleBlur(e);
                      }}
                      onFocus={(e) => {
                  ...
                  <Grid container spacing={2} sx={{ paddingTop: "20px" }}>
                    ...
                    <Grid item xs={3}>
                      <CustomTextField
                        ...
                        value={
                          clientIndividualFormValidation.values?.middleName
                        }
                        onChange={clientIndividualFormValidation.handleChange}
                        maxLength="10"
                        readOnly={editMode && true}
                    ...
                    <Grid item xs={3}>
                      <CustomTextField
                        ...
                        value={
                          clientIndividualFormValidation.values?.familyName
                        }
                        onChange={clientIndividualFormValidation.handleChange}
                        maxLength="10"
                        readOnly={editMode && true}
                  ...
                  <Grid
                    container
                    spacing={2}
                    sx={{ flexDirection: "row-reverse", paddingTop: "5px" }}
                  >
                    <Grid item xs={3}>
                      <CustomTextField
                        name="fl_firstName"
                        ...
                        value={
                          clientIndividualFormValidation.values?.fl_firstName
                        }
                        onChange={clientIndividualFormValidation.handleChange}
                        maxLength="10"
                        readOnly={editMode && true}
                    ...
                    <Grid item xs={3}>
                      <CustomTextField
                        ...
                        value={
                          clientIndividualFormValidation.values?.fl_middleName
                        }
                        onChange={clientIndividualFormValidation.handleChange}
                        readOnly={editMode && true}
                        dir="rtl" // Set direction to right-to-left
                    ...
                    <Grid item xs={3}>
                      <CustomTextField
                        ...
                        value={
                          clientIndividualFormValidation.values?.fl_lastName
                        }
                        onChange={clientIndividualFormValidation.handleChange}
                        maxLength="10"
                        dir="rtl" // Set direction to right-to-left
                    ...
                    <Grid item xs={3}>
                      <CustomTextField
                        ...
                        value={
                          clientIndividualFormValidation.values?.fl_familyName
                        }
                        onChange={clientIndividualFormValidation.handleChange}
                        readOnly={editMode && true}
                        dir="rtl" // Set direction to right-to-left
                ...
                <Grid container sx={{ marginTop: "20px" }}>
                  <FieldSet title={_labels.workAddress}>
                    <AddressTab
                      labels={_labels}
                      addressValidation={WorkAddressValidation}
                      countryStore={countryStore}
                      cityStore={cityAddressWorkStore}
                      setCityStore={setCityAddressWorkStore}
                      lookupCity={lookupCityAddressWork}
                      stateStore={stateAddressWorkStore}
                      fillStateStore={fillStateStoreAddressWork}
                      lookupCityDistrict={lookupCityDistrictAddressWork}
                  ...
                  <Grid item xs={12}>
                    <FormControlLabel
                      control={
                        <Checkbox
                          disabled={
                            clientIndividualFormValidation.values.genderId === 2
                              ? editMode
                                ? true
                                : false
                              : true
