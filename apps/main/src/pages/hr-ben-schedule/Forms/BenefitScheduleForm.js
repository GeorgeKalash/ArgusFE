...
export default function BenefitScheduleForm({ labels, maxAccess, recordId }) {
  ...
  const { formik } = useForm({
    ...
    onSubmit: async obj => {
      const response = await postRequest({
        extension: BenefitsRepository.BenefitSchedule.set,
  ...
  return (
    <FormShell resourceId={ResourceIds.BenefitSchedule} form={formik} maxAccess={maxAccess} editMode={editMode}>
      <VertLayout>
        <Grow>
