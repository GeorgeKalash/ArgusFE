...
const MODULE_PACKAGE_NAME = '@argus/module-remittance';
const MODULE_FOLDER = 'module-remittance';
...
const SALES_PAGES = [
  ...
  'rt-cor-disp-map',
  'ow-return-reason',
  'rt-fees-schedule-inw-map',
  'ct-extra-income',
  'rt-fees-schedule-map',
  'rt-fees-schedule',
  'correspondent-control',
  'rt-cor-group',
  'auto-post-excl',
  'mobile-system-defaults',
  'rt-default',
  'currency-exchange-map',
  'global-exchange-buy-map',
  'correspondent-agent-branches',
  'agents',
  'rt-legal-dt',
  'interface',
  'product-master',
  'inward-settlement',
  'open-inward-transfers',
  'inward-transfer',
  'open-owr',
  'post-outwards',
  'assign-out-corr',
